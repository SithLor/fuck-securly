function ENCRYPT(e) {
    ...
    var n, r, i, a, s, c, l, u, d, h = new Array(80), g = 1732584193, w = 4023233417, f = 2562383102, m = 271733878, p = 3285377520, v = (e = function(e) {
        e = e.replace(/\r\n/g, "\n");
...
function fetchClusterUrl() {
    var e = window.userEmail.split("@")[1], t = createBlockingRequest("get", checkClusterURL + "/crextn/cluster?domain=" + e + "&reasonCode=" + window.clusterFound), o = localStorage.getItem("cluster");
...
function skipCacheAndLogAlways(e, t) {
    return checkDomain(t, "twitter.com") ? 1 : checkDomain(t, "facebook.com") ? 1 : googleDomains.indexOf(parsedUrl.hostname.replace(/(^www\.)|(^\.)/, "")) >= 0 && !checkDomain(t, "mail.google.com") && !checkDomain(t, "drive.google.com") ? 1 : checkDomain(t, "bing.com") ? 1 : checkDomain(t, "search.yahoo.com") ? 1 : checkDomain(t, "wikipedia.org") ? 1 : checkDomain(t, "youtube.com") ? 1 : 0;
}
...
function interceptOrNot(e) {
    var t = 0, o = e.type, n = e.url, r = getLocation(n).hostname, i = getLocation(n).pathname;
    ...
    if (window.failedOpenObj && window.failedOpenObj.isFailedOpen()) {
        ...
        if (window.failedOpenObj.isWideOpenMode()) t = 0;
            ...
            var u = ENCRYPT(r), d = localStorage.getItem("NC:" + u);
...
function getBlockUrl(e, t, o, n, r) {
    ...
    if ("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t || (s = t), "BL" != t && "BL_SRCH" != t || (i = "G" == e ? "globalblacklist" : "policyblacklist", t = "BL"), "WL" != t && "WL_SRCH" != t || (i = "whitelistonly", t = "WL"), "BANNED" == t && (i = "banned"), "unknown" != window.clusterUrl) {
        var c = window.atob(n), l = c.substr(c.indexOf("://") + 3);
        n = window.btoa(l);
        var u = "";
        return u = window.clusterUrl.replace("/crextn", "") + "/blocked?useremail=" + window.userEmail + "&reason=" + i + "&categoryid=" + t + "&policyid=" + e + "&keyword=" + a + "&url=" + n + "&ver=" + window.version + (1 == r ? "&subFrame=1" : "") + "&extension_id=" + chrome.runtime.id, window.geoLat && window.geoLng && (u += "&lat=" + window.geoLat + "&lng=" + window.geoLng), s && (u += "&listType=" + s), u;
    }
}
function takeDenyActionTabs(e, t, o, n, r, i, a) {
    ...
    if ("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t || (l = t), "BL" != t && "BL_SRCH" != t || (s = "G" == e ? "globalblacklist" : "policyblacklist", t = "BL"), "BANNED" == t && (s = "banned"), "WL" != t && "WL_SRCH" != t || (s = "whitelistonly", t = "WL"), "unknown" != window.clusterUrl) {
        var u = window.atob(n), d = u.substr(u.indexOf("://") + 3);
        n = window.btoa(d);
        var h = window.clusterUrl.replace("/crextn", ""), g = window.userEmail, w = "";
...
function takeDenyAction(e, t, o) {
    ...
    var i = window.atob(o), a = i.substr(i.indexOf("://") + 3);
    o = window.btoa(a);
    var s = window.clusterUrl.replace("/crextn", "") + "/blocked?useremail=" + window.userEmail + "&reason=" + n + "&categoryid=" + t + "&policyid=" + e + "&url=" + o + "&ver=" + window.version + (1 == window.isSubFrame ? "&subFrame=1" : "") + "&extension_id=" + chrome.runtime.id;
...
function checkSkipListCaching(e) {
    ...
    o.href = e.url;
    var n = cleanURL(o.hostname.toLowerCase()), r = Math.floor(Date.now() / 1e3), i = Object.keys(window.skipList);
    if (i && -1 != i.indexOf(n)) {
...
function invalidateSkipListCaching(e, t) {
    ...
    if (t) for(var n = 0; n < o.length; n++)window.skipList[o[n]].last_broker_call = 0;
    else {
...
function extractTranslateHostname(e) {
    var t = "translate.google.com", o = getQueryVariable(e, "u");
    if ("" != o) {
...
function sendDebugInfo(e) {
    var t = window.clusterUrl + "/debug", o = new XMLHttpRequest;
...
function clearWebCache(e) {
    ...
    try {
        var o = window.atob(e), n = new URL(o).hostname.replace("www.", "");
...
function siteUrlToBrokerUrl(e) {
    var t = document.createElement("a");
    t.href = e;
    var o = t.hostname.toLowerCase(), n = window.btoa(e);
                ...
                t.skiplist.forEach(function(e) {
                    ...
                    if (void 0 !== t && t.trim().length > 0) {
                        if (o[t] = {
                            ...
                            var n = t.replaceAll(".", "\\.").replaceAll("*", ".*").replaceAll("/", "\\/"), r = new RegExp(n);
                            o[t].regx = r;
                        }
...
function sendSHDataToServer(e, t, o, n) {
    if (isClusterURLAvailable()) {
        t = window.clusterUrl + "/flaggedSearches?search=" + window.btoa(e) + "&url=" + window.btoa(t) + "&match=" + window.btoa(o) + "&domain=" + window.btoa(n) + "&extension_id=" + chrome.runtime.id;
...
function sendSocialPostToServer(e, t, o, n) {
    if (isClusterURLAvailable()) {
        n = window.clusterUrl + "/socialActivity?msg=" + window.btoa(encodeURIComponent(e)) + "&domain=" + window.btoa(t) + "&context=" + window.btoa(o) + "&url=" + window.btoa(n) + "&extension_id=" + chrome.runtime.id;
...
!function(e, t) {
    ...
    var e, t, o, n, r, i, a, s, c, l = l || function(e, t) {
        ...
        var n = function() {
            ...
            concat: function(e) {
                ...
                else for(i = 0; i < r; i += 4)t[n + i >>> 2] = o[i >>> 2];
            ...
            _process: function(t) {
                var o, n = this._data, r = n.words, i = n.sigBytes, a = this.blockSize, s = i / (4 * a), l = (s = t ? e.ceil(s) : e.max((0 | s) - this._minBufferSize, 0)) * a, u = e.min(4 * l, i);
                if (l) {
    ...
    return function() {
        ...
        e.enc.Base64 = {
            stringify: function(e) {
                ...
                e.clamp();
                for(var r = [], i = 0; i < o; i += 3)for(var a = (t[i >>> 2] >>> 24 - i % 4 * 8 & 255) << 16 | (t[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255) << 8 | t[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, s = 0; s < 4 && i + .75 * s < o; s++)r.push(n.charAt(a >>> 6 * (3 - s) & 63));
                var c = n.charAt(64);
                if (c) for(; r.length % 4;)r.push(c);
                return r.join("");
            },
            parse: function(e) {
                var o = e.length, n = this._map, r = this._reverseMap;
                if (!r) {
                    r = this._reverseMap = [];
                ...
                return function(e, o, n) {
                    for(var r = [], i = 0, a = 0; a < o; a++)if (a % 4) {
                        var s = n[e.charCodeAt(a - 1)] << a % 4 * 2, c = n[e.charCodeAt(a)] >>> 6 - a % 4 * 2, l = s | c;
                        r[i >>> 2] |= l << 24 - i % 4 * 8, i++;
                    }
                    return t.create(r, i);
                }(e, o, r);
        ...
        var t = l, o = t.lib, n = o.WordArray, r = o.Hasher, i = t.algo, a = [];
        !function() {
        ...
        var s = i.MD5 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                ...
                var i = this._hash.words, s = e[t + 0], l = e[t + 1], g = e[t + 2], w = e[t + 3], f = e[t + 4], m = e[t + 5], p = e[t + 6], v = e[t + 7], y = e[t + 8], b = e[t + 9], k = e[t + 10], _ = e[t + 11], S = e[t + 12], O = e[t + 13], C = e[t + 14], L = e[t + 15], x = i[0], B = i[1], R = i[2], U = i[3];
                B = h(B = h(B = h(B = h(B = d(B = d(B = d(B = d(B = u(B = u(B = u(B = u(B = c(B = c(B = c(B = c(B, R = c(R, U = c(U, x = c(x, B, R, U, s, 7, a[0]), B, R, l, 12, a[1]), x, B, g, 17, a[2]), U, x, w, 22, a[3]), R = c(R, U = c(U, x = c(x, B, R, U, f, 7, a[4]), B, R, m, 12, a[5]), x, B, p, 17, a[6]), U, x, v, 22, a[7]), R = c(R, U = c(U, x = c(x, B, R, U, y, 7, a[8]), B, R, b, 12, a[9]), x, B, k, 17, a[10]), U, x, _, 22, a[11]), R = c(R, U = c(U, x = c(x, B, R, U, S, 7, a[12]), B, R, O, 12, a[13]), x, B, C, 17, a[14]), U, x, L, 22, a[15]), R = u(R, U = u(U, x = u(x, B, R, U, l, 5, a[16]), B, R, p, 9, a[17]), x, B, _, 14, a[18]), U, x, s, 20, a[19]), R = u(R, U = u(U, x = u(x, B, R, U, m, 5, a[20]), B, R, k, 9, a[21]), x, B, L, 14, a[22]), U, x, f, 20, a[23]), R = u(R, U = u(U, x = u(x, B, R, U, b, 5, a[24]), B, R, C, 9, a[25]), x, B, w, 14, a[26]), U, x, y, 20, a[27]), R = u(R, U = u(U, x = u(x, B, R, U, O, 5, a[28]), B, R, g, 9, a[29]), x, B, v, 14, a[30]), U, x, S, 20, a[31]), R = d(R, U = d(U, x = d(x, B, R, U, m, 4, a[32]), B, R, y, 11, a[33]), x, B, _, 16, a[34]), U, x, C, 23, a[35]), R = d(R, U = d(U, x = d(x, B, R, U, l, 4, a[36]), B, R, f, 11, a[37]), x, B, v, 16, a[38]), U, x, k, 23, a[39]), R = d(R, U = d(U, x = d(x, B, R, U, O, 4, a[40]), B, R, s, 11, a[41]), x, B, w, 16, a[42]), U, x, p, 23, a[43]), R = d(R, U = d(U, x = d(x, B, R, U, b, 4, a[44]), B, R, S, 11, a[45]), x, B, L, 16, a[46]), U, x, g, 23, a[47]), R = h(R, U = h(U, x = h(x, B, R, U, s, 6, a[48]), B, R, v, 10, a[49]), x, B, C, 15, a[50]), U, x, m, 21, a[51]), R = h(R, U = h(U, x = h(x, B, R, U, S, 6, a[52]), B, R, w, 10, a[53]), x, B, k, 15, a[54]), U, x, l, 21, a[55]), R = h(R, U = h(U, x = h(x, B, R, U, y, 6, a[56]), B, R, L, 10, a[57]), x, B, p, 15, a[58]), U, x, O, 21, a[59]), R = h(R, U = h(U, x = h(x, B, R, U, f, 6, a[60]), B, R, _, 10, a[61]), x, B, g, 15, a[62]), U, x, b, 21, a[63]), i[0] = i[0] + x | 0, i[1] = i[1] + B | 0, i[2] = i[2] + R | 0, i[3] = i[3] + U | 0;
            },
    ...
    }), e.SHA1 = n._createHelper(i), e.HmacSHA1 = n._createHmacHelper(i), function(e) {
        var t = l, o = t.lib, n = o.WordArray, r = o.Hasher, i = t.algo, a = [], s = [];
        !function() {
            function t(t) {
            ...
            _doProcessBlock: function(e, t) {
                for(var o = this._hash.words, n = o[0], r = o[1], i = o[2], a = o[3], l = o[4], u = o[5], d = o[6], h = o[7], g = 0; g < 64; g++){
                    if (g < 16) c[g] = 0 | e[t + g];
                        ...
                        var w = c[g - 15], f = (w << 25 | w >>> 7) ^ (w << 14 | w >>> 18) ^ w >>> 3, m = c[g - 2], p = (m << 15 | m >>> 17) ^ (m << 13 | m >>> 19) ^ m >>> 10;
                        c[g] = f + c[g - 7] + p + c[g - 16];
                    }
                    var v = n & r ^ n & i ^ r & i, y = (n << 30 | n >>> 2) ^ (n << 19 | n >>> 13) ^ (n << 10 | n >>> 22), b = h + ((l << 26 | l >>> 6) ^ (l << 21 | l >>> 11) ^ (l << 7 | l >>> 25)) + (l & u ^ ~l & d) + s[g] + c[g];
        ...
        var e = l, t = e.lib.WordArray, o = e.enc;
        o.Utf16 = o.Utf16BE = {
            stringify: function(e) {
        ...
        var t = l, o = t.lib, n = o.WordArray, r = o.Hasher, i = t.algo, a = n.create([
            0,
            1,
            2,
            3,
            ...
            _doProcessBlock: function(e, t) {
                ...
                var i, l, g, b, k, _, S, O, C, L, x, B = this._hash.words, R = d.words, U = h.words, N = a.words, A = s.words, D = c.words, T = u.words;
                _ = i = B[0], S = l = B[1], O = g = B[2], C = b = B[3], L = k = B[4];
                for(o = 0; o < 80; o += 1)x = i + e[t + N[o]] | 0, x += o < 16 ? w(l, g, b) + R[0] : o < 32 ? f(l, g, b) + R[1] : o < 48 ? m(l, g, b) + R[2] : o < 64 ? p(l, g, b) + R[3] : v(l, g, b) + R[4], x = (x = y(x |= 0, D[o])) + k | 0, i = k, k = b, b = y(g, 10), g = l, l = x, x = _ + e[t + A[o]] | 0, x += o < 16 ? v(S, O, C) + U[0] : o < 32 ? p(S, O, C) + U[1] : o < 48 ? m(S, O, C) + U[2] : o < 64 ? f(S, O, C) + U[3] : w(S, O, C) + U[4], x = (x = y(x |= 0, T[o])) + L | 0, _ = L, L = C, C = y(O, 10), O = S, S = x;
                x = B[1] + g + C | 0, B[1] = B[2] + b + L | 0, B[2] = B[3] + k + _ | 0, B[3] = B[4] + i + S | 0, B[4] = B[0] + l + O | 0, B[0] = x;
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, o = 8 * this._nDataBytes, n = 8 * e.sigBytes;
        ...
        var e = l, t = e.lib.Base, o = e.enc.Utf8;
        ...
        var e = l, t = e.lib, o = t.Base, n = t.WordArray, r = e.algo, i = r.SHA1, a = r.HMAC, s = r.PBKDF2 = o.extend({
            cfg: o.extend({
                keySize: 4,
                hasher: i,
                iterations: 1
            ...
            compute: function(e, t) {
                for(var o = this.cfg, r = a.create(o.hasher, e), i = n.create(), s = n.create([
                    1
                ]), c = i.words, l = s.words, u = o.keySize, d = o.iterations; c.length < u;){
        ...
        var e = l, t = e.lib, o = t.Base, n = t.WordArray, r = e.algo, i = r.MD5, a = r.EvpKDF = o.extend({
            cfg: o.extend({
                keySize: 4,
                hasher: i,
                iterations: 1
        ...
        var e = l, t = e.lib.WordArray, o = e.algo, n = o.SHA256, r = o.SHA224 = n.extend({
            _doReset: function() {
        ...
        var t = l, o = t.lib, n = o.Base, r = o.WordArray, i = t.x64 = {};
        i.Word = n.extend({
            init: function(e, t) {
        ...
        var t = l, o = t.lib, n = o.WordArray, r = o.Hasher, i = t.x64.Word, a = t.algo, s = [], c = [], u = [];
        !function() {
        ...
        var h = a.SHA3 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var o = this._state, n = this.blockSize / 2, r = 0; r < n; r++){
                    var i = e[t + 2 * r], a = e[t + 2 * r + 1];
                    i = 16711935 & (i << 8 | i >>> 24) | 4278255360 & (i << 24 | i >>> 8), a = 16711935 & (a << 8 | a >>> 24) | 4278255360 & (a << 24 | a >>> 8), (B = o[r]).high ^= a, B.low ^= i;
                }
                for(var l = 0; l < 24; l++){
                    for(var h = 0; h < 5; h++){
                        for(var g = 0, w = 0, f = 0; f < 5; f++){
                            g ^= (B = o[h + 5 * f]).high, w ^= B.low;
                        }
                        var m = d[h];
                        m.high = g, m.low = w;
                    }
                    for(h = 0; h < 5; h++){
                        var p = d[(h + 4) % 5], v = d[(h + 1) % 5], y = v.high, b = v.low;
                        for(g = p.high ^ (y << 1 | b >>> 31), w = p.low ^ (b << 1 | y >>> 31), f = 0; f < 5; f++){
                            (B = o[h + 5 * f]).high ^= g, B.low ^= w;
                        }
                    }
                    for(var k = 1; k < 25; k++){
                        var _ = (B = o[k]).high, S = B.low, O = s[k];
                        O < 32 ? (g = _ << O | S >>> 32 - O, w = S << O | _ >>> 32 - O) : (g = S << O - 32 | _ >>> 64 - O, w = _ << O - 32 | S >>> 64 - O);
                        var C = d[c[k]];
                        C.high = g, C.low = w;
                    }
                    var L = d[0], x = o[0];
                    L.high = x.high, L.low = x.low;
                    for(h = 0; h < 5; h++)for(f = 0; f < 5; f++){
                        var B = o[k = h + 5 * f], R = d[k], U = d[(h + 1) % 5 + 5 * f], N = d[(h + 2) % 5 + 5 * f];
            ...
            _doFinalize: function() {
                var t = this._data, o = t.words, r = (this._nDataBytes, 8 * t.sigBytes), i = 32 * this.blockSize;
        ...
        var e = l, t = e.lib.Hasher, o = e.x64, n = o.Word, r = o.WordArray, i = e.algo;
        function a() {
        ...
        var u = i.SHA512 = t.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var o = this._hash.words, n = o[0], r = o[1], i = o[2], a = o[3], l = o[4], u = o[5], d = o[6], h = o[7], g = n.high, w = n.low, f = r.high, m = r.low, p = i.high, v = i.low, y = a.high, b = a.low, k = l.high, _ = l.low, S = u.high, O = u.low, C = d.high, L = d.low, x = h.high, B = h.low, R = g, U = w, N = f, A = m, D = p, T = v, E = y, I = b, F = k, H = _, P = S, q = O, M = C, W = L, z = x, j = B, V = 0; V < 80; V++){
                    var G, K, J = c[V];
                    if (V < 16) K = J.high = 0 | e[t + 2 * V], G = J.low = 0 | e[t + 2 * V + 1];
                    else {
                        var Y = c[V - 15], Z = Y.high, X = Y.low, $ = (Z >>> 1 | X << 31) ^ (Z >>> 8 | X << 24) ^ Z >>> 7, Q = (X >>> 1 | Z << 31) ^ (X >>> 8 | Z << 24) ^ (X >>> 7 | Z << 25), ee = c[V - 2], te = ee.high, oe = ee.low, ne = (te >>> 19 | oe << 13) ^ (te << 3 | oe >>> 29) ^ te >>> 6, re = (oe >>> 19 | te << 13) ^ (oe << 3 | te >>> 29) ^ (oe >>> 6 | te << 26), ie = c[V - 7], ae = ie.high, se = ie.low, ce = c[V - 16], le = ce.high, ue = ce.low;
                        K = (K = (K = $ + ae + ((G = Q + se) >>> 0 < Q >>> 0 ? 1 : 0)) + ne + ((G += re) >>> 0 < re >>> 0 ? 1 : 0)) + le + ((G += ue) >>> 0 < ue >>> 0 ? 1 : 0), J.high = K, J.low = G;
                    }
                    var de, he = F & P ^ ~F & M, ge = H & q ^ ~H & W, we = R & N ^ R & D ^ N & D, fe = U & A ^ U & T ^ A & T, me = (R >>> 28 | U << 4) ^ (R << 30 | U >>> 2) ^ (R << 25 | U >>> 7), pe = (U >>> 28 | R << 4) ^ (U << 30 | R >>> 2) ^ (U << 25 | R >>> 7), ve = (F >>> 14 | H << 18) ^ (F >>> 18 | H << 14) ^ (F << 23 | H >>> 9), ye = (H >>> 14 | F << 18) ^ (H >>> 18 | F << 14) ^ (H << 23 | F >>> 9), be = s[V], ke = be.high, _e = be.low, Se = z + ve + ((de = j + ye) >>> 0 < j >>> 0 ? 1 : 0), Oe = pe + fe;
                    z = M, j = W, M = P, W = q, P = F, q = H, F = E + (Se = (Se = (Se = Se + he + ((de = de + ge) >>> 0 < ge >>> 0 ? 1 : 0)) + ke + ((de = de + _e) >>> 0 < _e >>> 0 ? 1 : 0)) + K + ((de = de + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((H = I + de | 0) >>> 0 < I >>> 0 ? 1 : 0) | 0, E = D, I = T, D = N, T = A, N = R, A = U, R = Se + (me + we + (Oe >>> 0 < pe >>> 0 ? 1 : 0)) + ((U = de + Oe | 0) >>> 0 < de >>> 0 ? 1 : 0) | 0;
                }
                w = n.low = w + U, n.high = g + R + (w >>> 0 < U >>> 0 ? 1 : 0), m = r.low = m + A, r.high = f + N + (m >>> 0 < A >>> 0 ? 1 : 0), v = i.low = v + T, i.high = p + D + (v >>> 0 < T >>> 0 ? 1 : 0), b = a.low = b + I, a.high = y + E + (b >>> 0 < I >>> 0 ? 1 : 0), _ = l.low = _ + H, l.high = k + F + (_ >>> 0 < H >>> 0 ? 1 : 0), O = u.low = O + q, u.high = S + P + (O >>> 0 < q >>> 0 ? 1 : 0), L = d.low = L + W, d.high = C + M + (L >>> 0 < W >>> 0 ? 1 : 0), B = h.low = B + j, h.high = x + z + (B >>> 0 < j >>> 0 ? 1 : 0);
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, o = 8 * this._nDataBytes, n = 8 * e.sigBytes;
        ...
        var e = l, t = e.x64, o = t.Word, n = t.WordArray, r = e.algo, i = r.SHA512, a = r.SHA384 = i.extend({
            _doReset: function() {
                this._hash = new n.init([
        ...
        var t = l, o = t.lib, n = o.Base, r = o.WordArray, i = o.BufferedBlockAlgorithm, a = t.enc, s = (a.Utf8, a.Base64), c = t.algo.EvpKDF, u = o.Cipher = i.extend({
            cfg: n.extend(),
            ...
            blockSize: 1
        }), t.mode = {}), h = o.BlockCipherMode = n.extend({
            createEncryptor: function(e, t) {
            ...
            stringify: function(e) {
                ...
                return (o ? r.create([
                    1398893684,
                    1701076831
                ]).concat(o).concat(t) : t).toString(s);
            },
            parse: function(e) {
            ...
            encrypt: function(e, t, o, n) {
                n = this.cfg.extend(n);
                var r = e.createEncryptor(o, n), i = r.finalize(t), a = r.cfg;
                return f.create({
                    ciphertext: i,
                    key: o,
                    iv: a.iv,
            ...
            execute: function(e, t, o, n) {
                ...
                var i = c.create({
                    keySize: t + o
                }).compute(e, n), a = r.create(i.words.slice(t), 4 * o);
        ...
        return e.Encryptor = e.extend({
            ...
            processBlock: function(e, o) {
                var n = this._cipher, r = n.blockSize, i = e.slice(o, o + r);
        ...
        pad: function(e, t) {
            var o = e.sigBytes, n = 4 * t, r = n - o % n, i = o + r - 1;
        ...
        pad: function(e, t) {
            ...
            e.concat(l.lib.WordArray.random(n - 1)).concat(l.lib.WordArray.create([
                n << 24
            ], 1));
        },
        unpad: function(e) {
        ...
        processBlock: function(e, t) {
            var o = this._cipher, n = o.blockSize, r = this._iv, i = this._keystream;
        ...
        var t = l, o = t.lib.CipherParams, n = t.enc.Hex;
        t.format.Hex = {
            stringify: function(e) {
        ...
        var e = l, t = e.lib.BlockCipher, o = e.algo, n = [], r = [], i = [], a = [], s = [], c = [], u = [], d = [], h = [], g = [];
        !function() {
            ...
            for(t = 0; t < 256; t++){
                ...
                var f = e[o], m = e[f], p = e[m], v = 257 * e[w] ^ 16843008 * w;
        ...
        var w = [
            ...
            _doCryptBlock: function(e, t, o, n, r, i, a, s) {
                for(var c = this._nRounds, l = e[t] ^ o[0], u = e[t + 1] ^ o[1], d = e[t + 2] ^ o[2], h = e[t + 3] ^ o[3], g = 4, w = 1; w < c; w++){
                    var f = n[l >>> 24] ^ r[u >>> 16 & 255] ^ i[d >>> 8 & 255] ^ a[255 & h] ^ o[g++], m = n[u >>> 24] ^ r[d >>> 16 & 255] ^ i[h >>> 8 & 255] ^ a[255 & l] ^ o[g++], p = n[d >>> 24] ^ r[h >>> 16 & 255] ^ i[l >>> 8 & 255] ^ a[255 & u] ^ o[g++], v = n[h >>> 24] ^ r[l >>> 16 & 255] ^ i[u >>> 8 & 255] ^ a[255 & d] ^ o[g++];
                    l = f, u = m, d = p, h = v;
                }
        ...
        var e = l, t = e.lib, o = t.WordArray, n = t.BlockCipher, r = e.algo, i = [
            57,
            49,
            41,
            33,
        ...
        var e = l, t = e.lib.StreamCipher, o = e.algo, n = o.RC4 = t.extend({
            _doReset: function() {
                for(var e = this._key, t = e.words, o = e.sigBytes, n = this._S = [], r = 0; r < 256; r++)n[r] = r;
                r = 0;
                for(var i = 0; r < 256; r++){
                    var a = r % o, s = t[a >>> 2] >>> 24 - a % 4 * 8 & 255;
                    i = (i + n[r] + s) % 256;
                    var c = n[r];
                    n[r] = n[i], n[i] = c;
                }
        ...
        var o = e.Encryptor = e.extend({
            processBlock: function(e, o) {
                ...
                i && (a = this._counter = i.slice(0), this._iv = void 0), function(e) {
        ...
        var e = l, t = e.lib.StreamCipher, o = [], n = [], r = [], i = e.algo.Rabbit = t.extend({
            _doReset: function() {
                ...
                if (t) {
                    var i = t.words, s = i[0], c = i[1], l = 16711935 & (s << 8 | s >>> 24) | 4278255360 & (s << 24 | s >>> 8), u = 16711935 & (c << 8 | c >>> 24) | 4278255360 & (c << 24 | c >>> 8), d = l >>> 16 | 4294901760 & u, h = u << 16 | 65535 & l;
        ...
        function a() {
            ...
            for(o = 0; o < 8; o++){
                var i = e[o] + t[o], a = 65535 & i, s = i >>> 16, c = ((a * a >>> 17) + a * s >>> 15) + s * s, l = ((4294901760 & i) * i | 0) + ((65535 & i) * i | 0);
                r[o] = c ^ l;
            }
        ...
        var e = l.lib.BlockCipherMode.extend(), t = e.Encryptor = e.extend({
            processBlock: function(e, t) {
                var o = this._cipher, n = o.blockSize, r = this._iv, i = this._counter;
        ...
        var e = l, t = e.lib.StreamCipher, o = [], n = [], r = [], i = e.algo.RabbitLegacy = t.extend({
            _doReset: function() {
                var e = this._key.words, t = this.cfg.iv, o = this._X = [
                    e[0],
                    e[3] << 16 | e[2] >>> 16,
                    e[1],
                    e[0] << 16 | e[3] >>> 16,
            ...
            !function(n) {
                ...
                r.fromInt = function(e, t) {
                    ...
                    for(var i = r.fromNumber(Math.pow(o, 8)), a = r.ZERO, s = 0; s < e.length; s += 8){
                        var c = Math.min(8, e.length - s), l = parseInt(e.substring(s, s + c), o);
                        if (c < 8) {
                ...
                var s = 4294967296, c = s * s, l = c / 2, u = r.fromInt(1 << 24);
                r.ZERO = r.fromInt(0), r.UZERO = r.fromInt(0, !0), r.ONE = r.fromInt(1), r.UONE = r.fromInt(1, !0), r.NEG_ONE = r.fromInt(-1), r.MAX_VALUE = r.fromBits(-1, 2147483647, !1), r.MAX_UNSIGNED_VALUE = r.fromBits(-1, -1, !0), r.MIN_VALUE = r.fromBits(0, -2147483648, !1), r.prototype.toInt = function() {
                    ...
                    if (this.isNegative()) {
                        if (this.equals(r.MIN_VALUE)) {
                            var o = r.fromNumber(e), n = this.div(o);
                    ...
                    t = this;
                    for(var a = "";;){
                        var s = t.div(i), c = (t.subtract(s.multiply(i)).toInt() >>> 0).toString(e);
                    ...
                    var t = this.high >>> 16, o = 65535 & this.high, n = this.low >>> 16, i = 65535 & this.low, a = e.high >>> 16, s = 65535 & e.high, c = e.low >>> 16, l = 0, u = 0, d = 0, h = 0;
                    ...
                    var t = this.high >>> 16, o = 65535 & this.high, n = this.low >>> 16, i = 65535 & this.low, a = e.high >>> 16, s = 65535 & e.high, c = e.low >>> 16, l = 65535 & e.low, d = 0, h = 0, g = 0, w = 0;
...
function notifyProxyIdentified(e) {
    if (isClusterURLAvailable() && !identifiedWebsites.includes(e.proxyUrl)) {
        var t = createNonBlockingRequest("post", window.clusterUrl + "/proxy"), o = new FormData;
...
function cookieMonster(e) {
    [
        ...
        "scru_geo",
        "scru_geoIpAddress"
    ].includes(e.name) || isValidPassCookie(e) || chrome.cookies.remove({
...
function isValidPassCookie(e) {
    ...
    try {
        var t = decodeURIComponent(e.value), o = JSON.parse(window.atob(t));
...
function getSocialPost(e, t) {
    var o = "", n = "", r = new URL(e.url);
    if (checkDomain(e.url, "twitter.com") && (r.pathname.includes(window.twitterMessageURI) || r.pathname.includes("graphql") && r.pathname.includes("CreateTweet")) && "POST" == e.method && "xmlhttprequest" == e.type) {
        var i = "";
        void 0 !== e.requestBody.raw ? ("" == (i = extractTweet(n = buff2StrWithEmoji(e.requestBody.raw[0].bytes))) && (i = extractPost(n, "&status=", "&tagged_users")), i = i.replaceAll("\n", " "), i = encodeURIComponent(i), o = window.btoa(i.toLowerCase())) : (i = (i = e.requestBody.formData.status[0]).replaceAll("\n", " "), i = encodeURIComponent(i), o = window.btoa(i.toLowerCase()));
    }
    checkDomain(t, "facebook.com") && (r.pathname.includes("updatestatus") || r.pathname.includes("webgraphql")) && "POST" == e.method && "xmlhttprequest" == e.type && (n = buff2StrWithEmoji(e.requestBody.raw[0].bytes), a = (a = extractFBPost(decodeURIComponent(n))).replaceAll("\n", " "), a = encodeURIComponent(a), o = window.btoa(a.toLowerCase()));
    if (checkDomain(t, "facebook.com") && r.pathname.includes("api/graphql") && "POST" == e.method && "xmlhttprequest" == e.type) {
        var a;
        if (!1 === (a = extractFBPostV2(e.requestBody.formData))) return a;
        a = a.replaceAll("\n", " "), a = encodeURIComponent(a), o = window.btoa(a.toLowerCase());
    }
    return o;
}
...
function extractPost(e, t, o) {
    var n = e.indexOf(t) + t.length, r = e.indexOf(o);
...
function extractFBPost(e) {
    var t, o, n;
    for(o = 0, n = (t = e.split("&")).length; o < n; o++)if (0 == t[0].indexOf("variables=")) return JSON.parse(t[0].substr(10)).input.message.text;
}
...
function getYoutubeSearchURL(e, t) {
    if (void 0 !== e.requestBody.raw) {
        var o = buff2StrWithEmoji(e.requestBody.raw[0].bytes), n = JSON.parse(o);
        void 0 !== n.query && (t = e.initiator + "/results?search_query=" + encodeURIComponent(n.query));
    }
    return t;
}
function getRespArrTabs(e, t, o, n, r, i = "", a = !1, s, c = null, l = !1) {
    void 0 !== l && l || (clearCacheIfTTLExpired(), l = !1);
    var u = _getResCode(e, t), d = "";
    if ("notloggedin" == userEmail) return (u = "DENY:0:-1:-1:-1:-1:-1").split(":");
    if (doBrokerForClassroom() && (u = ""), u) if (-1 != u.indexOf("ALLOW") && 0 == skipCacheAndLogAlways(e, n)) wellPathWidgBg.triggerWidgetDisplay();
    else {
        let s = null, g = null, w = null;
        if (selfClusterCheckBeforeBroker(), null != c && (g = c.channelId, s = c.videoId, w = c.category), d = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + o + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (a ? "&subframe=1" : "") + ("" != i ? "&frameHost=" + i : "") + (null != g ? "&channelID=" + g : "") + (null != s ? "&videoID=" + s : "") + (null != w ? "&category=" + encodeURIComponent(w) : "") + "&extension_id=" + chrome.runtime.id, l && (d += "&rebroker=1"), 0 == u.indexOf("SS") && stripSafeSearchPramas(n) == window.lastBrokeredRequest) return u.split(":");
        if (window.lastBrokeredRequest = n, "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            (h = createNonBlockingRequest("get", d)).onerror = function() {
                u = "ERROR:-1:-1:-1:-1:-1:-1";
            }, h.onload = function() {
                if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), 0 != (u = h.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    if (-1 == u.toLowerCase().indexOf("<html")) {
                        var o = u.split(":"), n = o[0], i = o[1], a = o[2], s = o[3], c = o[2], d = !1;
                        if (0 == isNaN(c) && c >= 0) {
                            var g = Long.fromString(c, !0).shiftRight(0).toNumber(), w = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                            Long.fromNumber(g).and(Math.pow(2, 36)).shiftRight(0).toNumber() == w && (d = !0);
                        }
                        ...
                        else "DENY" == n ? takeDenyActionTabs(i, a, s, t, r, 0, l) : "PAUSE" == n && takePauseActionTabs(t, r);
                    }
                } else {
                    var f = u.split(":");
        ...
        } else u = "ERORR:-1:-1:-1:-1:-1:-1";
    }
    else {
        let g = null, w = null, f = null;
        if (selfClusterCheckBeforeBroker(), null != c && (w = c.channelId, g = c.videoId, f = c.category), d = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + o + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (a ? "&subframe=1" : "") + ("" != i ? "&frameHost=" + i : "") + (null != w ? "&channelID=" + w : "") + (null != g ? "&videoID=" + g : "") + (null != f ? "&category=" + encodeURIComponent(f) : "") + "&extension_id=" + chrome.runtime.id, window.geolocation && (d = d + "&lat=" + window.geoLat + "&lng=" + window.geoLng), l && (d += "&rebroker=1"), 0 == a) {
            if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var h = createNonBlockingRequest("get", d);
        } else {
            let t = !1;
            if (isSeachRequest(e, n) && stripSafeSearchPramas(n) == window.lastBrokeredRequest && (t = !0), window.lastBrokeredRequest = n, !t && "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var h = createBlockingRequest("get", d);
        }
        if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            h.onerror = function() {
                u = "ERROR:-1:-1:-1:-1:-1:-1";
            }, h.onload = function() {
                if (0 != (u = h.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    null != window.failedOpenObj && (window.failedOpenObj = null);
                    var o = u.split(":")[2];
                    findCrextnBasegene(u), window.checkiFrames = u.split(":")[7];
                    var n = !1;
                    if (0 == isNaN(o) && o >= 0) {
                        var c = Long.fromString(o, !0).shiftRight(0).toNumber(), d = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                        Long.fromNumber(c).and(Math.pow(2, 36)).shiftRight(0).toNumber() == d && (n = !0);
                    }
                    if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), setClassroomCookies(), -1 == u.indexOf("DENY") && -1 == u.indexOf("PAUSE")) try {
                        ...
                        var g = u.split(":"), w = (g[0], g[1]), f = g[2], m = g[3];
                        g[4], g[5], g[6];
                        0 == a || 0 == window.checkiFrames ? (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, f, m, t, r, isSubFrame, l)) : 1 == window.checkiFrames && (s.iframeResp = g, "" !== i && window.atob(t) !== i ? (isSubFrame = !0, window.isSubFrame = !0, s.iframeBlockUrl = getBlockUrl(w, f, m, t, isSubFrame)) : (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, f, m, t, r, isSubFrame, l)));
                    }
                } else {
        ...
        } else u = "ERROR:-1:-1:-1:-1:-1:-1";
        u = googleDomains.indexOf(parsedUrl.hostname.replace(/(^www\.)|(^\.)/, "")) >= 0 && !checkDomain(n, "sites.google.com") && !checkDomain(n, "docs.google.com") && !checkDomain(n, "drive.google.com") && !checkDomain(n, "accounts.google.com") && !checkDomain(n, "calendar.google.com") && !checkDomain(n, "code.google.com") || checkDomain(n, "bing.com") ? "SS:0:-1:-1:-1:-1:-1" : "ALLOW:0:-1:-1:-1:-1:-1", checkDomain(n, "search.yahoo.com") && (u = "SS:0:CC:-1:-1:-1:-1");
    }
    var g = u.split(":");
    return (void 0 === g || null == g || g.length < 7) && (u = "ERROR:-1:-1:-1:-1:-1:-1", sessionStorage.removeItem(e), g = u.split(":")), g;
}
function getRespArr(e, t, o, n, r = "", i = !1) {
    var a = _getResCode(e, t), s = "";
    if (doBrokerForClassroom() && (a = ""), a) wellPathWidgBg.triggerWidgetDisplay();
    else if (selfClusterCheckBeforeBroker(), s = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + o + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (i ? "&subframe=1" : "") + ("" != r ? "&frameHost=" + r : "") + "&extension_id=" + chrome.runtime.id, window.geolocation && (s = s + "&lat=" + window.geoLat + "&lng=" + window.geoLng), "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
        var c = createBlockingRequest("get", s);
        c.onerror = function() {
            a = "ERROR:-1:-1:-1:-1:-1:-1";
        }, c.onload = function() {
            if (wellPathWidgBg.triggerWidgetDisplay(), setClearCacheCookie(), setClassroomCookies(), 0 != (a = c.responseText.trim()).indexOf("FAILED_OPEN:")) {
                var o = a.split(":")[2];
                window.checkiFrames = a.split(":")[7], findCrextnBasegene(a);
                var r = !1;
                if (0 == isNaN(o) && o >= 0) {
                    var i = Long.fromString(o, !0).shiftRight(0).toNumber(), s = Long.fromNumber(Math.pow(2, 36)).shiftRight(0).toNumber();
                    Long.fromNumber(i).and(Math.pow(2, 36)).shiftRight(0).toNumber() == s && (r = !0);
                }
                if (-1 == a.indexOf("DENY") && 0 == skipCacheAndLogAlways(e, n)) try {
                    -1 == a.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, a) : sessionStorage.setItem(window.atob(t).replace(/(^\w+:|^)\/\//, ""), a), 0 == r && (void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(e, a)), setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5);
                } catch (e) {
                    sessionStorage.clear();
                }
            } else {
    ...
    } else a = "ERROR:-1:-1:-1:-1:-1:-1";
    var l = a.split(":");
    return (void 0 === l || null == l || l.length < 7) && (l = (a = "ERROR:-1:-1:-1:-1:-1:-1").split(":"), sessionStorage.removeItem(e)), l;
}
function _getResCode(e, t) {
    var o = window.atob(t);
    resultURL = o.replace(/(^\w+:|^)\/\/|(\/$)/, "");
    var n = null, r = sessionStorage.getItem(resultURL);
    r ? 2 == (r = r.split(",")).length && (new Date).getTime() / 1e3 - r[1] < 1800 && (n = r[0]) : n = sessionStorage.getItem(e);
    return n;
}
function putURLCache(e, t, o, n) {
    -1 == e.indexOf("WL_URL") || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 ? 0 != n || void 0 !== window.crextnBasegene_bit0 && window.crextnBasegene_bit0 == window.bit0 || sessionStorage.setItem(o, e + "," + (new Date).getTime() / 1e3) : (resultURL = window.atob(t).replace(/(^\w+:|^)\/\//, ""), sessionStorage.setItem(resultURL, e + "," + (new Date).getTime() / 1e3));
}
...
function setupListener() {
    chrome.tabs.onCreated.addListener(function(e) {
        ...
        var n = new URL(o.url);
        void 0 !== t.status && n.pathname.startsWith("/blocked") ? "complete" != t.status ? (n.pathname.startsWith("/blocked") && checkDomain(o.url, "securly.com") || "iheobagjkfklnlikgihanlhcddjoihkg" === n.hostname) && (window.tabsBeingBlocked[e] = o.url) : delete window.tabsBeingBlocked[e] : void 0 !== t.status && "complete" == t.status && void 0 !== window.tabsBeingBlocked[e] && chrome.tabs.update(e, {
        ...
        if (e.requestHeaders.forEach(function(e) {
            ...
            var o = e.url, n = interceptOrNot(e);
            1 == n && (n = checkSkipListCaching(e));
            o.length > 1e3 && (o = o.substring(0, 1e3));
            var r = window.btoa(o), i = new URL(o).hostname.toLowerCase();
            ...
            if (1 == n) {
                ...
                if ("sub_frame" == e.type ? (c = !0, window.isSubFrame = !0, window.brokredRequest = []) : (window.isSubFrame = !1, c = !1, window.youtubeFrames = []), checkDomain(o, "youtube.com") && !1 === window.checkYouTube || !checkDomain(o, "youtube.com") || e.initiator !== window.refDomain) var u = getRespArr(new URL(o).hostname.replace(/^www\./, ""), r, "", o, s, c);
                var d = u[0], h = (u[1], u[2]), g = (u[3], u[4]), w = u[4];
                u[5], u[6];
        ...
        if ("outermost_frame" === e.frameType && checkDomain(t, "webpkgcache.com")) {
            var o = t.pathname.match(/\/([^\/]+)\/$/)[1];
            let n = btoa("https://" + o + "/"), r = new URL("https://" + o + "/");
            lHostName = r.hostname;
            let i = lHostName;
            lHostName = normalizeHostname(i);
            let a = getRespArrTabs(lHostName, n, "", "https://" + o + "/", e.tabId, "", !1, this), s = a[0], c = a[1], l = a[2];
            "DENY" == s && chrome.tabs.update(sender.sender.tab, takeDenyActionTabs(c, l, -1, n, e.tabId, !1, !1));
        }
    }, {
        urls: [
            "*://*.webpkgcache.com/*"
        ...
        lastKnownState != e && ("active" == e && "idle" != lastKnownState && (sessionStorage.clear(), window.featureConfig && 1 == window.featureConfig.reload_tabs ? rebrokerLoadedTabs() : chrome.windows.getAll({
            ...
            for(var t = 0; t < e.length; t++)for(var o = 0; o < e[t].tabs.length; o++)"chrome://" != e[t].tabs[o].url.substring(0, 9) && tabCheck.forEach(function(n) {
...
function onBeforeRequestListener(e, t = !1) {
    ...
    if ("main_frame" == e.type && !checkDomain(e.url, "securly.com") && void 0 !== window.tabsBeingBlocked[e.tabId]) return {
    ...
    if ("sub_frame" == e.type && "file://" == e.initiator && 0 === e.url.indexOf("http") && (r = 1), 1 == r && (r = checkSkipListCaching(e)), 1 != r) window.youtubeLastCheck = null, checkDomain(o, "youtube.com") && (window.ytURL = o, isClusterURLAvailable() && (null == window.ytOptionsLastCheck || Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600) && getYTOptions(), chrome.runtime.onConnect.addListener(function(t) {
        "yt" == t.name && t.onMessage.addListener(function(n, r) {
            if (window.checkYouTube && checkDomain(o, "youtube.com") && "GET" == e.method && "getYoutubeOptions" != n.action && "script" !== e.type && "stylesheet" !== e.type && "image" !== e.type) {
                if (window.youtubeLastCheck = Date.now(), isClusterURLAvailable() && -1 === window.youtubeFrames.indexOf(t.sender.frameId) && (null != n.channelId || null != n.videoId || null != n.category)) {
                    window.youtubeFrames[youtubeFrames.length] = t.sender.frameId;
                    let o = {
                        channelId: n.channelId,
                        videoId: n.videoId,
                        category: n.category
                    }, a = window.btoa(r.sender.url), s = document.createElement("a");
                    s.href = r.sender.url, l = normalizeHostname(l = s.hostname.toLowerCase());
                    let c = "", u = "";
                    if (void 0 !== e.initiator) {
                        var i = new URL(e.initiator);
                        u = window.btoa(i.hostname.toLowerCase());
                    }
                    let d = getRespArrTabs(l, a, c, r.sender.url, r.sender.tab.id, u, n.embedded, this, o), h = d[0], g = d[1];
                    d[2];
                    "DENY" == h ? 0 == n.embedded && chrome.tabs.update(r.sender.tab, takeDenyAction(g, 2, a)) : this.iframeResp.length > 0 && "DENY" == this.iframeResp[0] && (this.iframeResp = "", t.postMessage({
        ...
        "gmaps" == e.name && e.onMessage.addListener(function(e, t) {
            if (e.url != window.lastMapsUrl) {
                ...
                let o = window.btoa(e.url), n = document.createElement("a");
                n.href = e.url;
                let r = getRespArrTabs(l = normalizeHostname(l = n.hostname.toLowerCase()), o, "", e.url, t.sender.tab.id, "", !1, this), i = r[0], a = r[1];
                r[2];
        ...
        var i = "", a = !1;
        if (void 0 !== e.initiator) {
            var s = new URL(e.initiator);
            i = window.btoa(s.hostname);
        }
        "sub_frame" == e.type && (a = !0, window.isSubFrame = !0, window.brokredRequest = []);
        var c;
        if (o.length > 1e3 && (o = o.substring(0, 1e3)), c = getSocialPost(e, o), checkDomain(o, "youtube.com") && new URL(o).pathname.includes("youtubei/v1/search") && (o = getYoutubeSearchURL(e, o)), !1 === c) return;
        var l, u = window.btoa(o), d = o.replace(/^(?:https?:\/\/)?/i, "");
        if (d.endsWith("/") && (d = d.slice(0, -1)), window.brokeredArrIndex++, window.brokeredArrIndex >= 20 && (window.brokeredArrIndex = 0), -1 != window.brokredRequest.indexOf(d) && "" === c || (window.brokredRequest[window.brokeredArrIndex] = d), l = normalizeHostname(l = checkDomain(o, "translate.google.com") ? extractTranslateHostname(o) : new URL(o).hostname), window.geolocation && getRemoteIPGeo(), checkDomain(o, "youtube.com") && !1 === window.checkYouTube || !checkDomain(o, "youtube.com") || e.initiator !== window.refDomain) var h = getRespArrTabs(l, u, c, o, e.tabId, i, a, this, null, t);
        var g = h[0], w = h[1], f = h[2], m = (h[3], h[4], h[5], h[6], ""), p = "";
        ...
        if (!0 === v) {
            ...
            if (googleDomains.indexOf(e.hostname.replace(/(^www\.)|(^\.)/, "")) >= 0 && null !== y.get("q")) {
                ...
                if (checkDomain(o, "yahoo.com") && "cc" !== y.get("imgl") || checkDomain(o, "bing.com") && " filterui:licenseType-Any" !== y.get("qft")) return {
                    redirectUrl: n
                };
            }
        }
...
chrome.tabs.query({
    ...
    if ("text/html" == e.mime) {
        ...
        var o = window.btoa(t), n = document.createElement("a");
        n.href = t;
...
chrome.runtime.onConnect.addListener(function(e) {
    "gmeet" == e.name && e.onMessage.addListener(function(e, t) {
        if (e.url != previousMeetUrl) {
            ...
            let i = getRespArrTabs(lHostName, o, "", e.url, t.sender.tab.id, "", !1, this), a = i[0], s = i[1];
...
const wellPathWidgBg = function() {
    var e = null, t = 0, o = (o)=>{
        var n = new URL(window.clusterUrl).host;
        chrome.cookies.getAll({
            domain: n,
            ...
            const r = decodeURIComponent(n[0].value).split(":");
            if (!r.length || "show" == r[1]) try {
                const n = {
                    source: "well-path-widget",
                    action: "display",
                    data: await (async ()=>new Promise((o, n)=>{
                            "notloggedin" == userEmail && n();
                            try {
                                var r = (new Date).getTime() / 1e3;
                                if (r - t <= 5 && n("response was saved in last 5 seconds"), null != e && e.userEmail == userEmail && r - e.timestamp <= 1800) return console.debug("wpw valid content cache found. elapsed seconds:", r - e.timestamp), void o(e.content);
                                var i = window.clusterUrl + "/wellnessPathwaysWidgets?action=getWidget";
                                if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
                                    var a = createNonBlockingRequest("get", i);
                                    a.onerror = function() {
                                        ...
                                        }, o(t.widget.content)) : n();
                                    }, a.send();
                                } else n();
                            } catch (e) {
                                console.error("Error in fetching widget data", e), n();
                            }
                        }))()
                };
                void 0 !== o && o ? chrome.tabs.sendMessage(o, n) : chrome.tabs.query({}, (e)=>{
                    e.forEach((e, t)=>{
    ...
    return chrome.runtime.onMessage.addListener((e, n)=>{
        console.debug("wpw msg received", e, n), "object" == typeof e && void 0 !== e.action && void 0 !== e.source && void 0 !== n.tab.id && -1 != n.tab.id && n.tab.id && "well-path-widget" == e.source && ("ready" == e.action && o(n.tab.id), "ctaClicked" != e.action && "closed" != e.action || (function(e) {
            try {
                ...
                "ctaClicked" == e.action && (o.ctaLabel = e.label, o.ctaLink = e.link);
                var n = window.clusterUrl + "/wellnessPathwaysWidgets";
                if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
                    var r = createNonBlockingRequest("post", n);
...
function interceptRequest(e) {
    ...
    if (t && -1 != t.indexOf(mainHost)) for(let t = 0; t < window.vectorExpansionRules[mainHost].length; t += 1)try {
        ...
        let n = o.pattern, r = o.context, i = o.field, a = o.content, s = n.replaceAll(".", "\\.").replaceAll("*", ".*").replaceAll("/", "\\/"), c = new RegExp(s), l = "";
...
function interceptPostRequest(e, t, o, n, r, i, a, s) {
    if ("JSON_STR" == o) {
        let o = s.data.split("|").reduce((e, t)=>e[t], e);
        if (jsonInfo = JSON.parse(o), Array.isArray(n)) for(let e = 0; e < n.length; e += 1)tempText = removeHTMLTags(n[e].split("|").reduce((e, t)=>e[t], jsonInfo)), i = i.length > 0 ? i + " " + tempText : tempText;
        else i = removeHTMLTags(n.split("|").reduce((e, t)=>e[t], jsonInfo));
        ...
        if (buff = e.requestBody.raw[0].bytes, postContent = buff2StrWithEmoji(buff), Array.isArray(n)) for(let e = 0; e < n.length; e += 1)tempText = n[e].split("|").reduce((e, t)=>new URLSearchParams(e).get(t), postContent), i = i.length > 0 ? i + " " + tempText : tempText;
        ...
        let r = JSON.parse(o);
        if (Array.isArray(n)) for(let e = 0; e < n.length; e += 1)t.includes("tumblr.com") && "content" == n[e] ? tempText = removeHTMLTags(fetchStringFromJSONObj(r, "text")) : tempText = removeHTMLTags(n[e].split("|").reduce((e, t)=>e[t], r)), i = i.length > 0 ? i + " " + tempText : tempText;
        else i = removeHTMLTags(n.split("|").reduce((e, t)=>-1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]], r));
    } else if ("DOUBLE_ENCODED" == o) {
        buff = e.requestBody.raw[0].bytes, o = buff2StrWithEmoji(buff);
        let a = JSON.parse(o), s = n.split("||");
        if ("quora.com" == t && (a && a.queryName && -1 != a.queryName.indexOf("answerCreate") && (r = "ANSWER"), a && a.queryName && -1 != a.queryName.toLowerCase().indexOf("draft") && !0), s.length > 0) {
            var c = s[0].split("|").reduce((e, t)=>e[t], a);
    ...
    } else if (Array.isArray(n)) for(let o = 0; o < n.length; o += 1)tempText = removeHTMLTags(n[o].split("|").reduce((e, t)=>{
        try {
            return -1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]];
        } catch (e) {
            return "";
        }
    }, e)), "reddit.com" == t && -1 != n[o].indexOf("richtext_json") && tempText.length > 0 && (textStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "t")), captionStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "c")), tempText = textStr + " " + captionStr), i = i.length > 0 ? i + " " + tempText : tempText;

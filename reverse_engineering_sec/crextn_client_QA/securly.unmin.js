...
function ENCRYPT(e) {
    ...
    for(y.push(v >>> 29), y.push(v << 3 & 4294967295), o = 0; o < y.length; o += 16){
        for(r = 0; r < 16; r++)h[r] = y[o + r];
        for(r = 16; r <= 79; r++)h[r] = t(h[r - 3] ^ h[r - 8] ^ h[r - 14] ^ h[r - 16], 1);
        for(s = f, a = w, c = g, l = p, d = m, r = 0; r <= 19; r++)u = t(s, 5) + (a & c | ~a & l) + d + h[r] + 1518500249 & 4294967295, d = l, l = c, c = t(a, 30), a = s, s = u;
        for(r = 20; r <= 39; r++)u = t(s, 5) + (a ^ c ^ l) + d + h[r] + 1859775393 & 4294967295, d = l, l = c, c = t(a, 30), a = s, s = u;
        for(r = 40; r <= 59; r++)u = t(s, 5) + (a & c | a & l | c & l) + d + h[r] + 2400959708 & 4294967295, d = l, l = c, c = t(a, 30), a = s, s = u;
        for(r = 60; r <= 79; r++)u = t(s, 5) + (a ^ c ^ l) + d + h[r] + 3395469782 & 4294967295, d = l, l = c, c = t(a, 30), a = s, s = u;
...
function fetchClusterUrl() {
    ...
    if (n && 2 == (n = n.split(",")).length) {
        var o = 0;
        if ((o = (new Date).getTime() / 1e3 - n[1]) < 0 && (o = 31622400), o < 31536e3 && "UNKNOWN_SCHOOL" != n[0] && "unknown" != window.ClusterUrl) {
            if (window.clusterUrl = n[0], window.clusterFound = window.clusterStatus.FOUND, "UNKNOWN_SCHOOL" !== window.clusterUrl && "AVOID_OS" !== window.clusterUrl && "unknown" !== window.clusterUrl) return 1 == window.needToReloadTabs && (window.needToReloadTabs = 0, checkAllLoadedTabs()), latencyCheck(), getGeolocationStatus(), void getFeatureConfig();
            if (o < 3600 && "AVOID_OS" == window.clusterUrl) return void (window.clusterFound = window.clusterStatus.AVOID_OS);
        } else if (o < 3600 && ("UNKNOWN_SCHOOL" == n[0] || "unknown" == window.ClusterUrl)) return window.clusterUrl = n[0], void ("UNKNOWN_SCHOOL" == window.clusterUrl && (window.clusterFound = window.clusterStatus.UNKNOWN_SCHOOL));
    }
    ...
    return new Promise(function(n, o) {
        chrome.tabs.get(e, function(e) {
            if (e && "loading" == e.status) {
                if (urlDetails = new URL(t), "securly.com" == urlDetails.hostname.replace(/^[^.]+\./g, "") && ("blocked" == urlDetails.pathname || "blocked.php" == urlDetails.pathname) || "iheobagjkfklnlikgihanlhcddjoihkg" == urlDetails.hostname && "blocked.html" == urlDetails.pathname) return void n(!0);
                if (void 0 !== e.pendingUrl && (urlDetails = new URL(e.pendingUrl), "securly.com" == urlDetails.hostname.replace(/^[^.]+\./g, "") && ("blocked" == urlDetails.pathname || "blocked.php" == urlDetails.pathname) || "iheobagjkfklnlikgihanlhcddjoihkg" == urlDetails.hostname && "blocked.html" == urlDetails.pathname)) return void n(!0);
            }
            n(!1);
        });
    });
...
function interceptOrNot(e) {
    ...
    var c = ENCRYPT(s);
    if (null !== localStorage.getItem(c)) return window.featureConfig.isAwareOnly || window.featureConfig.isDiscernMode ? 0 : (takeDenyActionTabs("G", "BL", "", window.btoa(s), e.tabId), t = 0);
...
function takeDenyAction(e, t, n) {
    invalidateSkipListCaching(n, !1), clearWebCache(n);
    ...
    return function() {
        ...
        var c = [], d = i.SHA256 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var n = this._hash.words, o = n[0], r = n[1], i = n[2], s = n[3], l = n[4], d = n[5], u = n[6], h = n[7], f = 0; f < 64; f++){
                    ...
                    h = u, u = d, d = l, l = s + b | 0, s = i, i = r, r = o, o = b + (y + v) | 0;
                }
                n[0] = n[0] + o | 0, n[1] = n[1] + r | 0, n[2] = n[2] + i | 0, n[3] = n[3] + s | 0, n[4] = n[4] + l | 0, n[5] = n[5] + d | 0, n[6] = n[6] + u | 0, n[7] = n[7] + h | 0;
            },
            _doFinalize: function() {
                var t = this._data, n = t.words, o = 8 * this._nDataBytes, r = 8 * t.sigBytes;
        ...
        var t = l, n = t.lib, o = n.WordArray, r = n.Hasher, i = t.algo, s = o.create([
            ...
            _doProcessBlock: function(e, t) {
                ...
                O = i = B[0], k = l = B[1], x = f = B[2], S = b = B[3], C = _ = B[4];
                for(n = 0; n < 80; n += 1)L = i + e[t + N[n]] | 0, L += n < 16 ? w(l, f, b) + R[0] : n < 32 ? g(l, f, b) + R[1] : n < 48 ? p(l, f, b) + R[2] : n < 64 ? m(l, f, b) + R[3] : v(l, f, b) + R[4], L = (L = y(L |= 0, T[n])) + _ | 0, i = _, _ = b, b = y(f, 10), f = l, l = L, L = O + e[t + A[n]] | 0, L += n < 16 ? v(k, x, S) + U[0] : n < 32 ? m(k, x, S) + U[1] : n < 48 ? p(k, x, S) + U[2] : n < 64 ? g(k, x, S) + U[3] : w(k, x, S) + U[4], L = (L = y(L |= 0, E[n])) + C | 0, O = C, C = S, S = y(x, 10), x = k, k = L;
                L = B[1] + f + S | 0, B[1] = B[2] + b + C | 0, B[2] = B[3] + _ + O | 0, B[3] = B[4] + i + k | 0, B[4] = B[0] + l + x | 0, B[0] = L;
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, n = 8 * this._nDataBytes, o = 8 * e.sigBytes;
        ...
        t.RIPEMD160 = r._createHelper(f), t.HmacRIPEMD160 = r._createHmacHelper(f);
    }(Math), function() {
        ...
        var h = s.SHA3 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var n = this._state, o = this.blockSize / 2, r = 0; r < o; r++){
                    ...
                    i = 16711935 & (i << 8 | i >>> 24) | 4278255360 & (i << 24 | i >>> 8), s = 16711935 & (s << 8 | s >>> 24) | 4278255360 & (s << 24 | s >>> 8), (B = n[r]).high ^= s, B.low ^= i;
                }
                for(var l = 0; l < 24; l++){
                    for(var h = 0; h < 5; h++){
                        for(var f = 0, w = 0, g = 0; g < 5; g++){
                            f ^= (B = n[h + 5 * g]).high, w ^= B.low;
                        }
                        var p = u[h];
                        p.high = f, p.low = w;
                    }
                    ...
                    for(h = 0; h < 5; h++)for(g = 0; g < 5; g++){
                        ...
                        B.high = R.high ^ ~U.high & N.high, B.low = R.low ^ ~U.low & N.low;
                    }
                    B = n[0];
                    var A = d[l];
        ...
        var d = i.SHA512 = t.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var n = this._hash.words, o = n[0], r = n[1], i = n[2], s = n[3], l = n[4], d = n[5], u = n[6], h = n[7], f = o.high, w = o.low, g = r.high, p = r.low, m = i.high, v = i.low, y = s.high, b = s.low, _ = l.high, O = l.low, k = d.high, x = d.low, S = u.high, C = u.low, L = h.high, B = h.low, R = f, U = w, N = g, A = p, T = m, E = v, I = y, D = b, F = _, H = O, P = k, q = x, M = S, W = C, z = L, j = B, V = 0; V < 80; V++){
                    ...
                    z = M, j = W, M = P, W = q, P = F, q = H, F = I + (ke = (ke = (ke = ke + he + ((ue = ue + fe) >>> 0 < fe >>> 0 ? 1 : 0)) + _e + ((ue = ue + Oe) >>> 0 < Oe >>> 0 ? 1 : 0)) + K + ((ue = ue + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((H = D + ue | 0) >>> 0 < D >>> 0 ? 1 : 0) | 0, I = T, D = E, T = N, E = A, N = R, A = U, R = ke + (pe + we + (xe >>> 0 < me >>> 0 ? 1 : 0)) + ((U = ue + xe | 0) >>> 0 < ue >>> 0 ? 1 : 0) | 0;
                }
                w = o.low = w + U, o.high = f + R + (w >>> 0 < U >>> 0 ? 1 : 0), p = r.low = p + A, r.high = g + N + (p >>> 0 < A >>> 0 ? 1 : 0), v = i.low = v + E, i.high = m + T + (v >>> 0 < E >>> 0 ? 1 : 0), b = s.low = b + D, s.high = y + I + (b >>> 0 < D >>> 0 ? 1 : 0), O = l.low = O + H, l.high = _ + F + (O >>> 0 < H >>> 0 ? 1 : 0), x = d.low = x + q, d.high = k + P + (x >>> 0 < q >>> 0 ? 1 : 0), C = u.low = C + W, u.high = S + M + (C >>> 0 < W >>> 0 ? 1 : 0), B = h.low = B + j, h.high = L + z + (B >>> 0 < j >>> 0 ? 1 : 0);
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, n = 8 * this._nDataBytes, o = 8 * e.sigBytes;
        ...
        var w = [
            ...
            decryptBlock: function(e, t) {
                var n = e[t + 1];
                e[t + 1] = e[t + 3], e[t + 3] = n, this._doCryptBlock(e, t, this._invKeySchedule, d, u, h, f, r);
                n = e[t + 1];
                e[t + 1] = e[t + 3], e[t + 3] = n;
            },
...
function notifyProxyIdentified(e) {
    if (isClusterURLAvailable() && !identifiedWebsites.includes(e.proxyUrl)) {
        ...
        n.append("domain", e.proxyUrl), n.append("proxyFamily", e.proxyName), n.append("rules", JSON.stringify(e.targetElements || e.rules));
        try {
...
function cookieMonster(cookie) {
    ...
    const isCookieAllowed =allowedCookies.includes(cookie.name) 
    const isCookieValid = isValidPassCookie(cookie) 
    if (!isCookieAllowed && !isCookieValid) {
        const cookieUrl = "https://securly.com" + cookie.path;
...
function isValidPassCookie(e) {
    ...
    try {
        var t = decodeURIComponent(e.value), n = JSON.parse(window.atob(t));
    ...
    if (doBrokerForClassroom() && (d = ""), d) if (-1 != d.indexOf("ALLOW") && 0 == skipCacheAndLogAlways(e, o)) wellPathWidgBg.triggerWidgetDisplay();
        ...
        if (window.lastBrokeredRequest = o, "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            (h = createNonBlockingRequest("get", u)).onerror = function() {
                ...
                if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), 0 != (d = h.responseText.trim()).indexOf("FAILED_OPEN:")) {
        ...
        if (selfClusterCheckBeforeBroker(), null != c && (w = c.channelId, f = c.videoId, g = c.category), u = window.clusterUrl + "/broker?useremail=" + window.userEmail + "&reason=crextn&host=" + e + "&url=" + t + "&msg=" + n + "&ver=" + window.version + "&cu=" + window.clusterUrl + "&uf=" + window.userFound + "&cf=" + window.clusterFound + (s ? "&subframe=1" : "") + ("" != i ? "&frameHost=" + i : "") + (null != w ? "&channelID=" + w : "") + (null != f ? "&videoID=" + f : "") + (null != g ? "&category=" + encodeURIComponent(g) : "") + "&extension_id=" + chrome.runtime.id, window.geolocation && (u = u + "&lat=" + window.geoLat + "&lng=" + window.geoLng), l && (u += "&rebroker=1"), 0 == s) {
            if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var h = createNonBlockingRequest("get", u);
        } else {
            let t = !1;
            if (isSeachRequest(e, o) && stripSafeSearchPramas(o) == window.lastBrokeredRequest && (t = !0), window.lastBrokeredRequest = o, !t && "unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) var h = createBlockingRequest("get", u);
        }
        if ("unknown" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && "UNKNOWN_SCHOOL" != window.clusterUrl) {
            h.onerror = function() {
                d = "ERROR:-1:-1:-1:-1:-1:-1";
            }, h.onload = function() {
                if (0 != (d = h.responseText.trim()).indexOf("FAILED_OPEN:")) {
                    ...
                    if (void 0 !== l && l || setClearCacheCookie(r), wellPathWidgBg.triggerWidgetDisplay(), setClassroomCookies(), -1 == d.indexOf("DENY") && -1 == d.indexOf("PAUSE")) try {
                        ...
                        f[4], f[5], f[6];
                        0 == s || 0 == window.checkiFrames ? (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, g, p, t, r, isSubFrame, l)) : 1 == window.checkiFrames && (a.iframeResp = f, "" !== i && window.atob(t) !== i ? (isSubFrame = !0, window.isSubFrame = !0, a.iframeBlockUrl = getBlockUrl(w, g, p, t, isSubFrame)) : (window.isSubFrame = !1, isSubFrame = !1, takeDenyActionTabs(w, g, p, t, r, isSubFrame, l)));
                    }
                } else {
                    ...
                    if (window.failedOpenObj = new FailedOpen(m[1], m[2]), !window.failedOpenObj.isWideOpenMode()) {
                        ...
                        null == y || window.featureConfig.isDiscernMode || takeToFailedOpenBlockedPage(r, e, y);
                    }
                }
            };
            try {
        ...
        d = -1 != o.indexOf("google.c") && -1 == o.indexOf("sites.google.com") && -1 == o.indexOf("docs.google.com") && -1 == o.indexOf("drive.google.com") && -1 == o.indexOf("accounts.google.com") && -1 == o.indexOf("calendar.google.com") && -1 == o.indexOf("code.google.com") || -1 != o.indexOf("bing.com") ? "SS:0:-1:-1:-1:-1:-1" : "ALLOW:0:-1:-1:-1:-1:-1", o.includes("search.yahoo.com") && (d = "SS:0:CC:-1:-1:-1:-1");
    }
    var f = d.split(":");
...
function onBeforeRequestListener(e, t = FALSE) {
    ...
    n = o, "GET" === e.method && interceptRequest(e), "POST" == e.method && interceptRequest(e);
    ...
    if ("sub_frame" == e.type && "file://" == e.initiator && 0 === e.url.indexOf("http") && (r = 1), 1 == r && (r = checkSkipListCaching(e)), 1 != r) window.youtubeLastCheck = null, n.indexOf("youtube") && (window.ytURL = n, "UNKNOWN_SCHOOL" != window.clusterUrl && "AVOID_OS" != window.clusterUrl && (null == window.ytOptionsLastCheck || Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600) && getYTOptions(), chrome.runtime.onConnect.addListener(function(t) {
        ...
        if ("DENY" == f) return takeDenyAction(w, g, d);
        if ("PAUSE" == f) return getPauseAction(d);
        var v = !1;
        if ("SS" == f && (!1 !== (p = takeSafeSearchAction(c, o)) && (o = p), v = !0), "CC" == g && (!1 !== (m = takeCreativeCommonImageSearchAction(o)) && (o = m), v = !0), -1 !== n.indexOf("youtube.") && "REFWL" == g ? (window.refDomain = e.initiator, window.checkYouTube = !1) : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0), !0 === v) {
...
function interceptRequest(e) {
    ...
    var n = document.createElement("a");
    n.href = e.initiator, mainHost = cleanURL(n.hostname.toLowerCase()), -1 != mainHost.indexOf("www.") && (mainHost = mainHost.replace("www.", ""));
    if (t && -1 != t.indexOf(mainHost)) for(let t = 0; t < window.vectorExpansionRules[mainHost].length; t += 1)try {
        ...
        c.test(e.url) && ("GET" === e.method ? interceptGetRequest(e, l, mainHost, r, n, i) : "POST" === e.method && interceptPostRequest(e, mainHost, s, i, r, l, !1, n));
    } catch (e) {}
}
function interceptPostRequest(e, t, n, o, r, i, s, a) {
    if ("JSON_STR" == n) {
        let n = a.data.split("|").reduce((e, t)=>e[t], e);
        if (jsonInfo = JSON.parse(n), Array.isArray(o)) for(let e = 0; e < o.length; e += 1)tempText = removeHTMLTags(o[e].split("|").reduce((e, t)=>e[t], jsonInfo)), i = i.length > 0 ? i + " " + tempText : tempText;
        else i = removeHTMLTags(o.split("|").reduce((e, t)=>e[t], jsonInfo));
    ...
    } else if ("ENCODED_STR" == n) {
        if (buff = e.requestBody.raw[0].bytes, postContent = buff2StrWithEmoji(buff), Array.isArray(o)) for(let e = 0; e < o.length; e += 1)tempText = o[e].split("|").reduce((e, t)=>new URLSearchParams(e).get(t), postContent), i = i.length > 0 ? i + " " + tempText : tempText;
        else i = o.split("|").reduce((e, t)=>new URLSearchParams(e).get(t), postContent);
        i = removeHTMLTags("reddit.com" == t ? fetchStringFromJSONObj(JSON.parse(i), "t") : i);
    } else if ("ENCODED" == n) {
        buff = e.requestBody.raw[0].bytes, n = buff2StrWithEmoji(buff);
        let r = JSON.parse(n);
        if (Array.isArray(o)) for(let e = 0; e < o.length; e += 1)t.includes("tumblr.com") && "content" == o[e] ? tempText = removeHTMLTags(fetchStringFromJSONObj(r, "text")) : tempText = removeHTMLTags(o[e].split("|").reduce((e, t)=>e[t], r)), i = i.length > 0 ? i + " " + tempText : tempText;
        else i = removeHTMLTags(o.split("|").reduce((e, t)=>-1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]], r));
    } else if ("DOUBLE_ENCODED" == n) {
        buff = e.requestBody.raw[0].bytes, n = buff2StrWithEmoji(buff);
        let s = JSON.parse(n), a = o.split("||");
        if ("quora.com" == t && (s && s.queryName && -1 != s.queryName.indexOf("answerCreate") && (r = "ANSWER"), s && s.queryName && -1 != s.queryName.toLowerCase().indexOf("draft") && !0), a.length > 0) {
            var c = a[0].split("|").reduce((e, t)=>e[t], s);
            if (c) i = removeHTMLTags(i = fetchStringFromJSONObj(JSON.parse(c), "text"));
        }
    } else if ("QUERY_PARAM" == n) {
        i = new Proxy(new URLSearchParams(e.url), {
            get: (e, t)=>e.get(t)
        })[o];
    } else if (Array.isArray(o)) for(let n = 0; n < o.length; n += 1)tempText = removeHTMLTags(o[n].split("|").reduce((e, t)=>{
        try {
            return -1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]];
        } catch (e) {
            return "";
        }
    }, e)), "reddit.com" == t && -1 != o[n].indexOf("richtext_json") && tempText.length > 0 && (textStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "t")), captionStr = removeHTMLTags(fetchStringFromJSONObj(JSON.parse(tempText), "c")), tempText = textStr + " " + captionStr), i = i.length > 0 ? i + " " + tempText : tempText;
    else i = removeHTMLTags(o.split("|").reduce((e, t)=>-1 == t.indexOf("!") ? e[t] : e[t.split("!")[0]][t.split("!")[1]], e));
    i && -1 != i.trim().indexOf(" ") && sendSocialPostToServer(i, t, r, e.url);
}
function interceptGetRequest(e, t, n, o, r, i) {
    const s = {};
    new URL(e.url).search.split("&").forEach((e)=>{
        const [t, n] = e.split("=");
        s[t] = n;
    }), s[i] && (t = s[i]), "" !== t && sendSocialPostToServer(t, n, o, e.url);
}

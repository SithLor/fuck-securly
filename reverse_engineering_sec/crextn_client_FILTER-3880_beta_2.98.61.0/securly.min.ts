    ...
    return function() {
        ...
        var t = l, n = t.lib, o = n.WordArray, r = n.Hasher, i = t.algo, s = o.create([
            ...
            _doProcessBlock: function(e, t) {
                ...
                var i, l, h, b, _, O, k, x, S, C, B, L = this._hash.words, R = u.words, U = f.words, N = s.words, A = a.words, T = c.words, E = d.words;
                O = i = L[0], k = l = L[1], x = h = L[2], S = b = L[3], C = _ = L[4];
                for(n = 0; n < 80; n += 1)B = i + e[t + N[n]] | 0, B += n < 16 ? w(l, h, b) + R[0] : n < 32 ? g(l, h, b) + R[1] : n < 48 ? p(l, h, b) + R[2] : n < 64 ? m(l, h, b) + R[3] : v(l, h, b) + R[4], B = (B = y(B |= 0, T[n])) + _ | 0, i = _, _ = b, b = y(h, 10), h = l, l = B, B = O + e[t + A[n]] | 0, B += n < 16 ? v(k, x, S) + U[0] : n < 32 ? m(k, x, S) + U[1] : n < 48 ? p(k, x, S) + U[2] : n < 64 ? g(k, x, S) + U[3] : w(k, x, S) + U[4], B = (B = y(B |= 0, E[n])) + C | 0, O = C, C = S, S = y(x, 10), x = k, k = B;
        ...
        var f = s.SHA3 = r.extend({
            ...
            _doProcessBlock: function(e, t) {
                ...
                for(var l = 0; l < 24; l++){
                    ...
                    for(var _ = 1; _ < 25; _++){
                        var O = (L = n[_]).high, k = L.low, x = a[_];
        ...
        var d = i.SHA512 = t.extend({
            ...
            _doProcessBlock: function(e, t) {
                for(var n = this._hash.words, o = n[0], r = n[1], i = n[2], s = n[3], l = n[4], d = n[5], u = n[6], f = n[7], h = o.high, w = o.low, g = r.high, p = r.low, m = i.high, v = i.low, y = s.high, b = s.low, _ = l.high, O = l.low, k = d.high, x = d.low, S = u.high, C = u.low, B = f.high, L = f.low, R = h, U = w, N = g, A = p, T = m, E = v, I = y, D = b, F = _, H = O, P = k, q = x, M = S, W = C, z = B, j = L, V = 0; V < 80; V++){
                    var G, K, J = c[V];
                    ...
                    var ue, fe = F & P ^ ~F & M, he = H & q ^ ~H & W, we = R & N ^ R & T ^ N & T, ge = U & A ^ U & E ^ A & E, pe = (R >>> 28 | U << 4) ^ (R << 30 | U >>> 2) ^ (R << 25 | U >>> 7), me = (U >>> 28 | R << 4) ^ (U << 30 | R >>> 2) ^ (U << 25 | R >>> 7), ve = (F >>> 14 | H << 18) ^ (F >>> 18 | H << 14) ^ (F << 23 | H >>> 9), ye = (H >>> 14 | F << 18) ^ (H >>> 18 | F << 14) ^ (H << 23 | F >>> 9), be = a[V], _e = be.high, Oe = be.low, ke = z + ve + ((ue = j + ye) >>> 0 < j >>> 0 ? 1 : 0), xe = me + ge;
                    z = M, j = W, M = P, W = q, P = F, q = H, F = I + (ke = (ke = (ke = ke + fe + ((ue = ue + he) >>> 0 < he >>> 0 ? 1 : 0)) + _e + ((ue = ue + Oe) >>> 0 < Oe >>> 0 ? 1 : 0)) + K + ((ue = ue + G) >>> 0 < G >>> 0 ? 1 : 0)) + ((H = D + ue | 0) >>> 0 < D >>> 0 ? 1 : 0) | 0, I = T, D = E, T = N, E = A, N = R, A = U, R = ke + (pe + we + (xe >>> 0 < me >>> 0 ? 1 : 0)) + ((U = ue + xe | 0) >>> 0 < ue >>> 0 ? 1 : 0) | 0;
                }
                w = o.low = w + U, o.high = h + R + (w >>> 0 < U >>> 0 ? 1 : 0), p = r.low = p + A, r.high = g + N + (p >>> 0 < A >>> 0 ? 1 : 0), v = i.low = v + E, i.high = m + T + (v >>> 0 < E >>> 0 ? 1 : 0), b = s.low = b + D, s.high = y + I + (b >>> 0 < D >>> 0 ? 1 : 0), O = l.low = O + H, l.high = _ + F + (O >>> 0 < H >>> 0 ? 1 : 0), x = d.low = x + q, d.high = k + P + (x >>> 0 < q >>> 0 ? 1 : 0), C = u.low = C + W, u.high = S + M + (C >>> 0 < W >>> 0 ? 1 : 0), L = f.low = L + j, f.high = B + z + (L >>> 0 < j >>> 0 ? 1 : 0);
            },
            _doFinalize: function() {
                var e = this._data, t = e.words, n = 8 * this._nDataBytes, o = 8 * e.sigBytes;

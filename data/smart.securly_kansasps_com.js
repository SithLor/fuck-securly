...
var cluster = "useast2";    // Used to determine what DNS servers to access
var api_endpoint = "useast2.v1api.securly.com";
var fid = "securly@kansasps.com";			  // Reserved for future use	
var stateid = "ihbcbgzvzcg8";	  // This users state data
var did = "1n300d3uwf6pu";			  // Used to track the device
var logging = false; // Extra logging

// Informational
var user_agent = "Mozilla/5.0 (X11; CrOS x86_64 14541.0.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36";
var ua_browser = "Chrome 119.0.0";
var ua_os = "Chrome OS 14541.0.0";
...
var proxy_server = "PROXY useast2-dp.securly.com:80; DIRECT";
